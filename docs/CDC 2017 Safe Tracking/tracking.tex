...
\newcommand{\pcset}{\mathcal{A}} %planner control set
\newcommand{\pcfset}{\mathbb{A}} %planner control function set
\newcommand{\tcset}{\mathcal{B}} %tracker control set
\newcommand{\tcfset}{\mathbb{B}} %tracker control funciton set
\newcommand{\dset}{\mathcal{D}}
\newcommand{\dfset}{\mathbb{D}}

\newcommand{\pset}{\mathcal{S}_1} %planner set set
\newcommand{\tset}{\mathcal{S}_2} %tracker set
\newcommand{\rset}{\mathcal{S}_r}

\newcommand{\tvar}{t}
\newcommand{\thor}{T} % Time horizon

\newcommand{\tstate}{\state_2} % Tracker state
\newcommand{\pstate}{\state_1} % Planner state
\newcommand{\rstate}{\state_r} % Relative state


\newcommand{\ttraj}{\xi_{f2}} % Tracker trajectory
\newcommand{\ptraj}{\xi_{f1}} %Planner trajectory
\newcommand{\rtraj}{\xi_\rdyn}


\newcommand{\tctrl}{b} % Tracker control
\newcommand{\dstb}{d} % Disturbance
\newcommand{\pctrl}{a} % Planner control

\newcommand{\tdyn}{f_2} % Tracker dynamics
\newcommand{\pdyn}{f_1} % Planner Dynamics
\newcommand{\rdyn}{g} % Relative dynamics

\newcommand{\ptind}{s} % Index of vehicle state corresponding to planner state
\newcommand{\ptmat}{R} % Matrix for transforming planner state to the same length as tracker state
