...
We now have the dynamics for the individual systems, but to set up the capture-avoid game we must first define the relative states and dynamics. We subtract the virtual system states from the real system states to fix the virtual system at the origin:
