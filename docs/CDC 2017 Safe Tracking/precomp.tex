...
\begin{thm}
	\label{thm:main}
	\SHnote{still need to add better explanations in the proof}
	...
	\end{equation}
\end{thm}
Theorem \ref{thm:main} proves that every level set of $\valfunc_\infty(\rstate)$ is invariant under the following conditions:
	\begin{enumerate}
