...
\begin{enumerate}
	\item To provide a tool for precomputing functions (or look-up tables) to determine a guaranteed tracking error bound and optimal safety controller for robust motion planning with nonlinear dynamic systems
