...
\MCnote{How about use ``vehicle'' to refer to the real system, and ``reference system''? Maybe the states can be $s$ for vehicle, $r$ for virtual, and $e$ for tracking error, to reduce subscripts?}
