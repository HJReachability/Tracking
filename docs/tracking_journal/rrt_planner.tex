...
We define the relative system states to consist of the relative error states, or positions $(x_r, y_r, z_r)$, concatenated with the rest of the state variables of the 10D quadrotor model.
...
\begin{bmatrix}
  \begin{bmatrix}
    ...
    0_{3 \times 1} & \mathbf 0_{3 \times 3}
