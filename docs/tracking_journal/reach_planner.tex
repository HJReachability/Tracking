...
Computation was done on a desktop computer with a Core i7 5820K processor, on a $41\times41\times59\times35\times61$ grid, and took approximately 125 hours and required approximately 10 GB of RAM using a C++ implementation of level set methods for solving \eqref{eq:HJVI}.
...
The simulation was done in MATLAB on a desktop computer with a Core i7 2600K CPU.
