...
Fortunately, FaSTrack is modular with respect to the method for computating the TEB, and we are exploring techniques for computing TEBs for higher-dimensional systems through sum-of-squares optimization \cite{SinghChenEtAl2018} and \MCnote{neural networks \cite{}}.
