...
Offline, the pursuit-evasion game between the two models can be analyzed using any suitable method \SHnote{cite lygeros/tomlin/sastry and mitchell/bayen/tomlin?}, \cite{SinghChenEtAl2018},  \cite{royo2018classification}. 
...
FaSTrack was designed to be modular, and can be used with any method for computing the TEB in conjunction with any existing path or trajectory planning algorithms.  
