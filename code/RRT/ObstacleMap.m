      ...
      if plotLocal
        if size(self.local_obs,1)>0
          for i = 1:size(self.local_obs,3)
            g(i) = fill3([self.local_obs(1,1,i) self.local_obs(2,1,i) self.local_obs(3,1,i) self.local_obs(4,1,i) self.local_obs(1,1,i)] ...
      ...
      if plotPadded
        if size(self.padded_obs,1)>0
          for i = 1:size(self.padded_obs,3)
            k(i) = fill3([self.padded_obs(1,1,i) self.padded_obs(2,1,i) self.padded_obs(3,1,i) self.padded_obs(4,1,i) self.padded_obs(1,1,i)] ...
